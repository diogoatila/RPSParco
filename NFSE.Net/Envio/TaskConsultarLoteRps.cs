    ...
    public class TaskConsultarLoteRps : TaskAbst
    {
        public override void Execute(Empresa empresa)
        {
            ...
            if (padraoNFSe != PadroesNFSe.IPM)
            {
                ...
                oInvocarObj.InvocarNFSe(wsProxy, pedLoteRps, NomeMetodoWS(Servico, ler.oDadosPedSitNfseRps.cMunicipio, empresa.tpAmb), cabecMsg, this, "-ped-loterps", "-loterps", padraoNFSe, Servico, empresa);
            }
